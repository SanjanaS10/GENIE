...
from flowde_pinn import networks_2d
...
X0, _ = gendata.load_or_generate_gmm_2d(path=base_path+"X02d.pth", N=50000, K=20, device=DEVICE)
...
networks_2d.set_seed(42)


# Instantiating the model

model = networks_2d.PhysicsNN(x0,z).to(DEVICE)
