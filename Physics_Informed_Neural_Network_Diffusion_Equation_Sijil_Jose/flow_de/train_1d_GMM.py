...
X0, _ = gendata.load_or_generate_gmm_1d(path=base_path+"X01d.pth", N=50000, K=20, device=DEVICE)
...
networks_1d.set_seed(42)


# Instantiating the model

model = networks_1d.PhysicsNN(x0,z).to(DEVICE)
